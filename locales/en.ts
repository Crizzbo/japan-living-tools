  ...
  home: {
    ...
    articles: {
      ...
      items: {
        ...
        furusatoNozei: { title: 'Furusato Nozei Complete Guide', desc: 'Deduction limits, gift selection, and one-stop exception system explained.', date: '2025-06-20', tag: 'Tax' },
        cityCostComparison: { title: 'Japan City Cost of Living', desc: 'Rent, food, utilities across 8 cities — how much does \u00a55M yen really get you?', date: '2025-06-19', tag: 'Living' },
