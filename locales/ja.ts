  ...
  home: {
    ...
    articles: {
      ...
      items: {
        ...
        furusatoNozei: { title: 'ふるさと納税完全入門', desc: '控除上限額の計算から返礼品の選び方、ワンストップ特例まで。', date: '2025-06-20', tag: '税務' },
        cityCostComparison: { title: '都市別生活費の真実', desc: '8都市の家賃・食費・光熱費を比較。年収500万円の実質価値は都市でどう変わるか？', date: '2025-06-19', tag: '生活ガイド' },
